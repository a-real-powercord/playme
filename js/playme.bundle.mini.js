 ...
 * Javascript asks, are y'all loaded or what?!
 * MIT License
 */
! function(e, t) {
...
function total_duration() {
	...
	added_duration = 0
	var measured_time = new Date(null)
	duration_placeholder = document.getElementById('duration_placeholder');
	...
	measured_time.setSeconds(added_duration)
	var MHSTime = measured_time.toISOString().substr(11, 8);
	duration_placeholder.innerHTML = "Total Duration: " + MHSTime
	console.log(MHSTime)
}